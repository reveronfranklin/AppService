...
namespace AppService.Core.EntitiesFacturacion
{
    public partial class Ciny067
    {
        ...
        public decimal CtdEntregar { get; set; }
        public string EntPrefDesde { get; set; }
        public long EntNumDesde { get; set; }
        public string EntSufiDesde { get; set; }
        public string EntPrefHasta { get; set; }
        public long EntNumHasta { get; set; }
        public string EntSufiHasta { get; set; }
        public string FlagFaltante { get; set; }
        public int FacturaAfecta { get; set; }
        public int FormasBajotiro { get; set; }
        public int RemisionOfic { get; set; }
        public decimal CantidadOfic { get; set; }
        public DateTime? FechaOfic { get; set; }
        ...
        public decimal PrecioVentaR { get; set; }
        public decimal PrecioListaR { get; set; }
        public decimal VentaUnitDol { get; set; }
        public decimal ListaUnitDol { get; set; }
        public decimal ImpuestoDol { get; set; }
        public decimal ListaUnitDolr { get; set; }
        public decimal VentaUnitDolr { get; set; }
        public decimal ImpuestoDolR { get; set; }
    }
}
