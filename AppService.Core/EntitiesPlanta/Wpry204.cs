...
namespace AppService.Core.EntitiesPlanta
{
    public partial class Wpry204
    {
        ...
        public decimal Listabs { get; set; }
        public decimal Ventabs { get; set; }
        public decimal? RvalorLista { get; set; }
        public decimal? RvalorVenta { get; set; }
        public decimal? Rcambio { get; set; }
        public decimal? Rlistabs { get; set; }
        public decimal? Rventabs { get; set; }
    }
}
