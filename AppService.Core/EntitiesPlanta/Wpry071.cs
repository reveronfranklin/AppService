...
namespace AppService.Core.EntitiesPlanta
{
    public partial class Wpry071
    {
        ...
        public string Anchotxt { get; set; }
        public string Largotxt { get; set; }
        public string Actualizada { get; set; }
        public decimal Anchodec { get; set; }
        public decimal Largodec { get; set; }
        public string Imprimir { get; set; }
        public string Sort { get; set; }
        public short? Itemchange { get; set; }
    }
}
