...
{
    public partial class CopiaCsmy005
    {
        ...
        public decimal? OrdenRep { get; set; }
        public decimal? Posicion { get; set; }
        public string NombAbreviado { get; set; }
        public decimal? CodigoOverride { get; set; }
        public decimal? ExtTelefonica { get; set; }
        public string TlfCelular { get; set; }
        public decimal? NroDeClientes { get; set; }
        public string Activo { get; set; }
        public string CodigoGrupo { get; set; }
        public string FlagSupervisor { get; set; }
        public string FlagDeGerente { get; set; }
        public string Usuario { get; set; }
        public decimal? CotCorrelativo { get; set; }
        public decimal? Ordenado { get; set; }
        public decimal? Pais { get; set; }
        public decimal? Club300Asistid { get; set; }
        public decimal? PuntosDelClub { get; set; }
        public string EMail { get; set; }
        public decimal? CompanyBeeper { get; set; }
