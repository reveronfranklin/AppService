...
// Type: AppService.Core.Entities.MtrCliente
...
namespace AppService.Core.Entities
{
    public class MtrCliente
    {
        public MtrCliente()
        {
            ...
            this.CobGeneralCobranza = (ICollection<AppService.Core.Entities.CobGeneralCobranza>)new HashSet<AppService.Core.Entities.CobGeneralCobranza>();
        ...
        //public AppGeneralQuotes AppGeneralQuotes { get; set; }
        public virtual ICollection<AppService.Core.Entities.AppGeneralQuotes> AppGeneralQuotes { get; set; }

        public virtual ICollection<AppService.Core.Entities.CobGeneralCobranza> CobGeneralCobranza { get; set; }
