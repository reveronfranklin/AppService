...
namespace AppService.Core.EntitiesMooreve
{
    public partial class Wsmy662
    {
        ...
        public decimal? PrecioXcajaDescuento { get; set; }
        public decimal? PrecioLista { get; set; }
        public decimal? PrecioXcajaLista { get; set; }
        public decimal? PorcDescuento { get; set; }
        public decimal? PorcGenerarLista { get; set; }
        public decimal? ConsecutivoLista { get; set; }
    }
}
