...
namespace AppService.Core.EntitiesSap
{
    public partial class BsisTemp
    {
        ...
        public string Pgeber { get; set; }
        public string PgrantNbr { get; set; }
        public string Measure { get; set; }
        public string BudgetPd { get; set; }
        public string PbudgetPd { get; set; }
        public string Kidno { get; set; }
        public string Fipex { get; set; }
        public string Prodper { get; set; }
