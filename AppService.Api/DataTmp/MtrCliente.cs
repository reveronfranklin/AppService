...
{
    public partial class MtrCliente
    {
        public MtrCliente()
        {
            AppGeneralQuotes = new HashSet<AppGeneralQuote>();
            CobGeneralCobranzas = new HashSet<CobGeneralCobranza>();
        ...
        public virtual ICollection<CobGeneralCobranza> CobGeneralCobranzas { get; set; }
