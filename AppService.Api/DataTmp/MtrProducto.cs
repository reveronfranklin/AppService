...
{
    public partial class MtrProducto
    {
        public MtrProducto()
        {
            CatLista = new HashSet<CatListum>();
            CatMaterials = new HashSet<CatMaterial>();
            CatProductoMayorUnidadesConversions = new HashSet<CatProductoMayorUnidadesConversion>();
            OfdRenglons = new HashSet<OfdRenglon>();
        }
        ...
        public virtual ICollection<CatProductoMayorUnidadesConversion> CatProductoMayorUnidadesConversions { get; set; }
        public virtual ICollection<OfdRenglon> OfdRenglons { get; set; }
    }
}
